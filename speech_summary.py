...
SUMMARY_SYSTEM_PROMPT = (
    ...
    "- Write symbols and abbreviations as words, since the speech engine reads them "
    "literally: 'and' not '&', 'percent' not '%', 'degrees' not '°', 'dollars' after the "
    "number, 'for example' not 'e.g.'. Never join two numbers with a hyphen — write 'from "
    "2004 to 2008' and 'beat them 3 to 2', never '2004-2008' or '3-2'. Do this even if the "
    "original answer used the symbol.\n"
